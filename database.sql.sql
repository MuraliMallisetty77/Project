...
insert  into `exam_paper`(`id`,`a`,`b`,`c`,`d`,`e`,`f`,`g`,`hh`,`i`) values (1,'1','What is a correct syntax to output \"Hello World\" in Java?','print(\"Hello World\")','System.out.println(\"Hello World\")','echo(\"Hello World\")','Hello World','B','Basic Python  ','2022-04-16'),(2,'4','What is the correct file extension for Python files?','.pt','.java','.py','.html','C','Basic Python  ','2022-04-16'),(3,'2','How do you insert COMMENTS in Python code?','//','#','/*','*','B','Basic Python  ','2022-04-16'),(4,'3','Which one is NOT a legal variable name?','my_var','my-var','_myval','Myval','B','Basic Python  ','2022-04-16');
...
insert  into `finalresults`(`id`,`sid`,`semail`,`ename`,`edate`,`ca`,`ua`) values (1,'4560','cse.takeoff@gmail.com','Basic Python  ','2022-04-16','4','4');
...
insert  into `results`(`id`,`sid`,`sname`,`semail`,`ename`,`edate`,`ca`,`ua`,`status`) values (1,'4560','lakshmi','cse.takeoff@gmail.com','Basic Python  ','2022-04-16','B','B','Real'),(2,'4560','lakshmi','cse.takeoff@gmail.com','Basic Python  ','2022-04-16','C','C','Real'),(3,'4560','lakshmi','cse.takeoff@gmail.com','Basic Python  ','2022-04-16','B','B','Real'),(4,'4560','lakshmi','cse.takeoff@gmail.com','Basic Python  ','2022-04-16','B','B','Real');
